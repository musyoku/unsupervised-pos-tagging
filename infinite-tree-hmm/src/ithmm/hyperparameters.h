...
#define ITHMM_SBP_CONCENTRATION_VERTICAL_STRENGTH_MIN 	0.5
#define ITHMM_SBP_CONCENTRATION_VERTICAL_STRENGTH_MAX 	5
#define ITHMM_SBP_CONCENTRATION_HORIZONTAL_STRENGTH_MIN 0.5
#define ITHMM_SBP_CONCENTRATION_HORIZONTAL_STRENGTH_MAX 5
